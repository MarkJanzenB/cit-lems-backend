	...
	public void proceedToCheckOut(Map<Integer, Integer> itemQuantities, Map<Integer, Map<String, String>> uniqueIdsMap){
		...
		for(Map.Entry<Integer, Integer> entry: itemQuantities.entrySet()) {
			...
			if(categoryName == null || !categoryName.equalsIgnoreCase("Consumables")) {
				...
				if(uniqueIdMap != null) {
					for(String key: uniqueIdMap.keySet()) {
						...
						if (uid != null && !uid.isEmpty()) {
							// Changed to findByUniqueIdAndIsDeletedFalse
				...
				if(remaining > 0) {
					// Changed to findByItemNameAndIsAutoUidTrueAndStatusAndIsDeletedFalse
					List<ItemEntity> autoItems = itemRepository.findByItemNameAndIsAutoUidTrueAndStatusAndIsDeletedFalse(
					...
					if(fallbackRemaining > 0) {
						// Changed to findByItemNameAndIsAutoUidFalseAndStatusAndIsDeletedFalse
						List<ItemEntity> manualItems = itemRepository.findByItemNameAndIsAutoUidFalseAndStatusAndIsDeletedFalse(
